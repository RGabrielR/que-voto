        ...
        <>
          <div className="relative pt-7 ">
            <div className="translate-x-[3rem] -translate-y-4 lg:-translate-x-16 z-30">
              <Image
                className="absolute -left-2 lg:left-[4%] top-0 lg:top-6 w-52 sm:w-96 "
                src={questionMark}
                alt="signo de pregunta"
              />
              <Image
                className="absolute left-2 lg:left-[6%] top-0 lg:top-6 w-52 sm:w-96 opacity-[0.7] z-30"
                src={questionMark}
                alt="signo de pregunta"
              />
              <Image
                className="absolute left-6 lg:left-[8%] top-0 lg:top-6 w-52 sm:w-96 opacity-[0.5] z-30"
                src={questionMark}
                alt="signo de pregunta"
              />
            </div>
          ...
          <div className="flex flex-col  justify-center sm:flex-row sm:justify-around  sm:mt-12">
            <p
